...
sync_cfg server-icon.png                   server-icon.png   # 64x64, scripts/gen-server-icon.py
...
# Two-line gradient MOTD: generated by scripts/gen-motd.py into server/motd.txt.
set_prop motd "$(tr -d '\r\n' < "${REPO_DIR}/server/motd.txt")"
